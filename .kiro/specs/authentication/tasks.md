...
- [x] 1. Instalar Spatie Laravel Permission y preparar la configuración base
  - [x] 1.1 Instalar `spatie/laravel-permission` vía Composer y publicar sus migraciones
  ...
  - [x] 1.2 Crear el archivo de configuración `config/livesales.php`
...
- [x] 2. Extender la base de datos para el campo `is_active` y actualizar el modelo `User`
  - [x] 2.1 Crear la migración para añadir `is_active` a la tabla `users`
  ...
  - [x] 2.2 Actualizar el modelo `App\Models\User`
...
- [x] 3. Crear el middleware `EnsureUserIsActive` y registrar los aliases en `bootstrap/app.php`
  - [x] 3.1 Crear `App\Http\Middleware\EnsureUserIsActive`
  ...
  - [x] 3.2 Registrar aliases de middleware en `bootstrap/app.php`
    - En el closure `withMiddleware`, usar `$middleware->alias([...])` para registrar:
      - `'active'` → `App\Http\Middleware\EnsureUserIsActive::class`
      - `'role'` → `Spatie\Permission\Middleware\RoleMiddleware::class`
    - _Requirements: 3.1, 3.5, 7.1_

- [x] 4. Implementar la autenticación: `LoginRequest` y `AuthenticatedSessionController`
  - [x] 4.1 Crear `App\Http\Requests\Auth\LoginRequest`
  ...
  - [x] 4.2 Crear `App\Http\Controllers\Auth\AuthenticatedSessionController`
...
- [x] 5. Implementar `DeactivateUserAction` con protección del último Administrador activo
  - [x] 5.1 Crear `App\Actions\Users\DeactivateUserAction`
...
- [x] 6. Implementar `StoreUserRequest`, `UpdateUserRequest` y `UserController`
  - [x] 6.1 Crear `App\Http\Requests\StoreUserRequest`
  ...
  - [x] 6.2 Crear `App\Http\Requests\UpdateUserRequest`
  ...
  - [x] 6.3 Crear `App\Http\Controllers\UserController`
...
- [x] 7. Definir las rutas en `routes/web.php`
  - [x] 7.1 Registrar todas las rutas del módulo de autenticación
...
- [x] 8. Configurar Bootstrap 5 vía npm y Vite
  - [x] 8.1 Instalar Bootstrap 5 y sus dependencias mediante npm
  ...
  - [x] 8.2 Importar Bootstrap en los assets de Laravel
  ...
  - [x] 8.3 Configurar Vite y el paginador de Bootstrap
...
- [x] 10. Crear las vistas Blade con Bootstrap
  - [x] 10.1 Crear el layout principal `resources/views/layouts/app.blade.php`
  ...
  - [x] 10.2 Crear el layout de invitado `resources/views/layouts/guest.blade.php`
    - Layout limpio sin navegación para la página de login
    - Incluir Bootstrap 5 y un contenedor centrado
    - _Requirements: 1.1_

  - [x] 10.3 Crear la vista de login `resources/views/auth/login.blade.php`
  ...
  - [x] 10.4 Crear la vista de lista de usuarios `resources/views/users/index.blade.php`
  ...
  - [x] 10.5 Crear la vista de creación de usuario `resources/views/users/create.blade.php`
    - Extender `layouts.app`
  ...
  - [x] 10.6 Crear la vista de edición de usuario `resources/views/users/edit.blade.php`
    - Extender `layouts.app`
...
- [x] 11. Crear los seeders iniciales y actualizar `UserFactory`
  - [x] 11.1 Crear `Database\Seeders\RolesAndPermissionsSeeder`
  ...
  - [x] 11.2 Crear `Database\Seeders\AdminUserSeeder`
  ...
  - [x] 11.3 Actualizar `Database\Seeders\DatabaseSeeder`
  ...
  - [x] 11.4 Actualizar `Database\Factories\UserFactory`
...
- [x] 12. Checkpoint — Verificar estructura base antes de tests
...
- [x] 13. Escribir Feature Tests para las Correctness Properties
  - [x] 13.1 Crear `tests/Feature/Authentication/LoginTest.php`
  ...
  - [x] 13.2 Crear `tests/Feature/Authentication/LogoutTest.php`
  ...
  - [x] 13.3 Crear `tests/Feature/Authentication/RouteProtectionTest.php`
  ...
  - [x] 13.4 Crear `tests/Feature/Authentication/UserManagementTest.php`
  ...
  - [x] 13.5 Crear `tests/Feature/Authentication/UserActivationTest.php`
  ...
  - [x] 13.6 Crear `tests/Feature/Authentication/RoleAssignmentTest.php`
  ...
  - [x] 13.7 Crear `tests/Feature/Authentication/SeederTest.php`
...
- [x] 14. Checkpoint final — Asegurarse de que todos los tests pasen
